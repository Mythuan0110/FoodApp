...
public class CartHoaDonAdapter extends RecyclerView.Adapter<CartHoaDonAdapter.MyViewHolder> {
    ...
    public CartHoaDonAdapter(ArrayList<Order> cartList, Context context) {
